...
namespace MediaCodecHelper
{
    public class FileToMp4
    {
        ...
        public async Task<long> CalculatePresentationTimestampAsync(long bytesWritten, long totalBitsWritten)
        {
            await Task.Run(() =>
            {
                _totalBitsWritten = totalBitsWritten;
