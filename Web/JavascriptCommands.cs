...
namespace BitChute
{
    class JavascriptCommands
    {
        ...
        public class CallBackInjection
        {
            ...
            public static string PlayPauseButtonCallback = @"$(""button[data-plyr*='play']"")[0].addEventListener('click', function(){if(plyr.playing){window.location='https://_&app_play_invoked/';}else{window.location='https://_&app_pause_invoked/';}}, true);"
